...
export class StakingContract___votingSnapshotsResult {
  value0: BigInt;
  value1: BigInt;
...
export class StakingContract__assetsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class StakingContract extends ethereum.SmartContract {
  ...
  _votingSnapshots(
    param0: Address,
    param1: BigInt
  ): StakingContract___votingSnapshotsResult {
    let result = super.call(
      "_votingSnapshots",
    ...
    return new StakingContract___votingSnapshotsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try__votingSnapshots(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<StakingContract___votingSnapshotsResult> {
    let result = super.tryCall(
      "_votingSnapshots",
      "_votingSnapshots(address,uint256):(uint128,uint128)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new StakingContract___votingSnapshotsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  assets(param0: Address): StakingContract__assetsResult {
    let result = super.call(
      "assets",
    ...
    return new StakingContract__assetsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_assets(
    param0: Address
  ): ethereum.CallResult<StakingContract__assetsResult> {
    let result = super.tryCall(
      "assets",
      "assets(address):(uint128,uint128,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new StakingContract__assetsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
...
export class InitializeTrustedForwarderCall extends ethereum.Call {
  get inputs(): InitializeTrustedForwarderCall__Inputs {
    return new InitializeTrustedForwarderCall__Inputs(this);
  }

  get outputs(): InitializeTrustedForwarderCall__Outputs {
    return new InitializeTrustedForwarderCall__Outputs(this);
  }
}

export class InitializeTrustedForwarderCall__Inputs {
  _call: InitializeTrustedForwarderCall;

  constructor(call: InitializeTrustedForwarderCall) {
    this._call = call;
  }
...
export class InitializeTrustedForwarderCall__Outputs {
  _call: InitializeTrustedForwarderCall;
